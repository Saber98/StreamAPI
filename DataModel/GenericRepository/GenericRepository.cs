...
namespace DataModel.GenericRepository
{
    ...
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        internal SIMSDataDBContext Context;
        ...
        public GenericRepository(SIMSDataDBContext context)
        {
            Context = context;
        ...
        public virtual void Update(TEntity entityToUpdate, bool updateChildren)
        {
            DbSet.Attach(entityToUpdate);
            if (updateChildren)
            {
